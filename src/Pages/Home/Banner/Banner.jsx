    ...
    return (
        <div className="carousel w-full h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute h-full flex items-center  rounded-lg left-0  top-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
                    <div className='text-white font-bold space-y-7 w-1/2 pl-12 '>
                        <h2 className='text-6xl'>Affordable Price for Car Servicing</h2>
                        <p>There are many variations of text Available, But The MAjority HAve stuff Alteration in Some Form</p>
                        <div className='flex'>
                            <button className="btn btn-secondary mr-5">Descover More</button>
